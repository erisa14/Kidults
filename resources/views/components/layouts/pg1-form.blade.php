<div class="bg-white rounded-3xl font absolute text-black inset-y-0 md:justify-center justify-end  self-center lg:right-96 lg:w-[30lvw] lg:h-[40lvh] md:right-10 md:w-[40lvw] p-10 flex flex-col lg:gap-4 md:gap-3 w-[90lvw] md:mt-0 mt-32">
